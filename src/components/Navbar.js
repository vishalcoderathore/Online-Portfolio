                    ...
                    <div className="collapse navbar-collapse" id="navbarNavbar">
                        <ul className="navbar-nav ml-auto" onClick={this.scrollWindow}>
                            <li className="nav-item" id="Home">
                                <a href="#aboutMe" className="nav-link active" onClick={this.closeNavbarButton}>Home</a>
                            </li>
                            <li className="nav-item" id="Education">
                                <a href="#edu" className="nav-link" onClick={this.closeNavbarButton}>Education</a>
                            </li>
                            <li className="nav-item" id="Work">
                                <a href="#myWork" className="nav-link" onClick={this.closeNavbarButton}>Work</a>
                            </li>
                            <li className="nav-item" id="Projects">
                                <a href="#myProjects" className="nav-link" onClick={this.closeNavbarButton}>Projects</a>
                            </li>
                            <li className="nav-item" id="Contact">
                                <a href="#myContact" className="nav-link" onClick={this.closeNavbarButton}>Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
